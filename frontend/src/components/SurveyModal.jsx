...
const QUESTIONS = [
  { text: 'What year are you?', options: ['1st Year', '2nd Year', '3rd Year', '4th Year', 'Others'] },
 ...
 */
export default function SurveyModal({ isOpen, photo, videoBlob, template = 'orgfest', bw = false, onClose, onDone }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { download_url, session_id, share_url } = await uploadSession(photo, payload, videoBlob, { template, bw })
