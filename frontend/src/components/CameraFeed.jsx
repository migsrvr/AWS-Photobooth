  ...
  return (
    <div className="relative w-full h-full rounded-xl overflow-hidden
      ...
      <video
        ...
        playsInline
        muted
        className={`w-full h-full object-cover absolute inset-0 transition-opacity duration-500 ${isReady ? 'opacity-100' : 'opacity-0'}`}
      />
      {!isReady && (
        <div className="text-white/40 text-center z-10">
          <svg
            width="48"
            height="48"
            viewBox="0 0 24 24"
